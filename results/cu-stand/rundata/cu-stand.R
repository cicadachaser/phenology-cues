...
#########################
runType="davisDat.Rdata" ##THIS DETERMINES WHAT KIND OF YEARS WE'RE USING!
...
numsims=15 # number of simulations of each type to do
...
numYears=200 #number of years to simulate
