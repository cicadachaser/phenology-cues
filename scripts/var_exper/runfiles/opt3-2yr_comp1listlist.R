...
runnum="opt3-2yr-comp1listlist" #Name for saving the results

#Climate parameters
yearstdMax=20 #max year variation to test
daystdMax=5 #max day variation to test
numpts=3 #number of year and day variation levels to test.
numYears=2 #number of years of climate to generate
