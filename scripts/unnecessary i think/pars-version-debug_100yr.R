...
runnum="debug_precip" #Name for saving the results

#Climate parameters
yearstdMax=20 #max year variation to test
daystdMax=5 #max day variation to test
numpts=5 #number of year and day variation levels to test.
numYears=100 #number of years of climate to generate
actprecip=TRUE #If false, set all precips to zero. If true, use the smoothed precip values
